...
<body>
    ...
    <div class="container-md content bg-aziende">
        ...
        <div class="row g-0 padding-top-content">

            <div class="col-xl-6 g-4">
                <a href="https://www.aqualandvasto.com">
                    <div class="ret btn2 ">
                        <div class="row gx-5 ">
                            <div class="col-md-6 ">
                                <img src="../assets/img/loghi aziende/aqualand.png" class="my-img2 " alt="...">
                            </div>
                            <div class="col-md-6 p-0 p-0">
                                <div class="txt-box ">
                                    <div class="my-text-box visible">
                                        Aqualand
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-xl-6 g-4">
                <a href="https://difonzobus.com">
                    <div class="ret btn2 ">
                        <div class="row gx-5 ">
                            <div class="col-md-6 ">
                                <img src="../assets/img/loghi aziende/di fonzo.png" class="my-img2 " alt="...">
                            </div>
            ...
            <div class="col-xl-6 g-4 ">
                <a href="https://www.enel.it">
                    <div class="ret btn2 ">
                        <div class="row gx-5 ">
                            <div class="col-md-6 ">
                                <img src="../assets/img/loghi aziende/enel.png" class="my-img2 " alt="...">
                            </div>
                            <div class="col-md-6 p-0">
                                <div class="txt-box">
                                    <div class="my-text-box visible">
            ...
            <div class="col-xl-6 g-4">
                <a href="http://www.energiaspa.eu">
                    <div class="ret btn2 ">
                        <div class="row gx-5 ">
                            <div class="col-md-6 ">
                                <img src="../assets/img/loghi aziende/energie_spa.png" class="my-img2 " alt="...">
                            </div>
                            <div class="col-md-6 p-0">
                                <div class="txt-box">
                                    <div class="my-text-box visible">
            ...
            <div class="col-xl-6 g-4">
                <a href="https://www.gransolarghella.com/">
                    <div class="ret btn2 ">
                        <div class="row gx-5 ">
                            <div class="col-md-6 ">
                                <img src="../assets/img/loghi aziende/gransolarghella.png" class="my-img2 " alt="...">
                            </div>
                            <div class="col-md-6 p-0">
                                <div class="txt-box">
                                    <div class="my-text-box visible">
            ...
            <div class="col-xl-6 g-4">
                <a href="http://puccioni.it/">
                    <div class="ret btn2 ">
                        <div class="row gx-5 ">
                            <div class="col-md-6 ">

                                <img src="../assets/img/loghi aziende/puccioni.png" class="my-img2 " alt="...">
                            </div>
                            <div class="col-md-6 p-0">
                                <div class="txt-box">
                                    <div class="my-text-box visible">
            ...
            <div class="col-xl-6 g-4">
                <a href="https://www.grupposolmar.it/aziende/hadri-tanks/">
                    <div class="ret btn2 ">
                        <div class="row gx-5 ">
                            <div class="col-md-6  ">
                                <!-- <div class="colore">test</div> -->
                                <img src="../assets/img/loghi aziende/hadri tanks.png" class="my-img2 " alt="...">
                            </div>
                            <div class="col-md-6 p-0">
                                <div class="txt-box">
                                    <div class="my-text-box visible">
            ...
            <div class="col-xl-6 g-4">
                <a href="https://de5.it/">
                    <div class="ret btn2 ">
                        <div class="row gx-5 ">
                            <div class="col-md-6 ">
                                <img src="../assets/img/loghi aziende/gruppo de cinque.png" class="my-img2 " alt="...">
                            </div>
                            <div class="col-md-6 p-0">
                                <div class="txt-box">
                                    <div class="my-text-box visible">
            ...
            <div class="col-xl-6 g-4">
                <a href="http://www.sicilsaldo.it/">
                    <div class="ret btn2 ">
                        <div class="row gx-5 ">
                            <div class="col-md-6 ">
                                <img src="../assets/img/loghi aziende/sicilsaldo.png" class="my-img2 " alt="...">
                            </div>
                            <div class="col-md-6 p-0">
                                <div class="txt-box">
                                    <div class="my-text-box visible">
            ...
            <div class="col-xl-6 g-4">
                <a href="https://www.comune.guilmi.ch.it/">
                    <div class="ret btn2 ">
                        <div class="row gx-5 ">
                            <div class="col-md-6">
                                <img src="../assets/img/loghi aziende/guilmi.png" class="my-img2 " alt="...">
                            </div>
                            <div class="col-md-6 p-0">
                                <div class="txt-box">
                                    <div class="my-text-box txt-p">
                                        Guilmi
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-xl-6 g-4">
                <a href="http://comunedilentella.it/hh/index.php">
                    <div class="ret btn2 ">
                        <div class="row gx-5 ">
                            <div class="col-md-6 ">
                                <img src="../assets/img/loghi aziende/lentella.png" class="my-img2 " alt="...">
                            </div>
                            <div class="col-md-6 p-0">
                                <div class="txt-box">
                                    <div class="my-text-box txt-p">
            ...
            <div class="col-xl-6 g-4">
                <a href="http://www.comune.monteodorisio.ch.it/hh/index.php">
                    <div class="ret btn2 ">
                        <div class="row gx-5 ">
                            <div class="col-md-6 ">
                                <img src="../assets/img/loghi aziende/montedorisio.png" class="my-img2 " alt="...">
                            </div>
                            <div class="col-md-6 p-0">
                                <div class="txt-box">
                                    <div class="my-text-box txt-p">
            ...
            <div class="col-xl-6 g-4">
                <a href="http://www.roccacasale.gov.it/hh/index.php">
                    <div class="ret btn2 ">
                        <div class="row gx-5 ">
                            <div class="col-md-6 ">
                                <img src="../assets/img/loghi aziende/roccacasale.png" class="my-img2 " alt="...">
                            </div>
                            <div class="col-md-6 p-0">
                                <div class="txt-box">
                                    <div class="my-text-box txt-p">
            ...
            <div class="col-xl-6 g-4">
                <a href="http://www.comune.tossicia.te.it/">
                    <div class="ret btn2 ">
                        <div class="row gx-5 ">
                            <div class="col-md-6 ">
                                <img src="../assets/img/loghi aziende/tossicia.png" class="my-img2 " alt="...">
                            </div>
                            <div class="col-md-6 p-0">
                                <div class="txt-box">
                                    <div class="my-text-box txt-p">
        ...
        <div class="row justify-content-center">
            <div class="col-xl-6  g-4">
                <a href="https://www.comune.vasto.ch.it/">
                    <div class="ret btn2 ">
                        <div class="row gx-5 ">
                            <div class="col-md-6 ">
                                <img src="../assets/img/loghi aziende/vasto.png" class="my-img2 " alt="...">
                            </div>
                            <div class="col-md-6 p-0">
                                <div class="txt-box">
                                    <div class="my-text-box txt-p">
