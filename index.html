...
<body class="not-scroll ">
    ...
    <!-- Container centrale -->
    <div class="container-md content bg-home">
        ...
        <div class="nav-border nav container-md " id="idnav">
            ...
            <div class="container-nav-logo">
                <a href="index.php"><img src="./assets/img/logo-black.svg" alt="Logo_GeoSolution" class="nav-logo "></a>
            </div>
        ...
        <div class="home-img-1 padding-top-content">
            <div class="">
                <picture class="d-block w-100">
                    <source media="(min-width:1000px)" srcset="./assets/img/home-img-1-pc.jpg">
                    <source media="(min-width:650px)" srcset="./assets/img/home-img-1-tablet.jpg">
                    <source media="(min-width:465px)" srcset="./assets/img/home-img-1-mobile.jpg">
                    <img src="./assets/img/home-img-1-mobile.jpg" class="d-block w-100" alt="Flowers">
                </picture>
            </div>
        </div>
        ...
        <div class="container-descrizione">
            <div class="img-piccone">
                <img src="./assets/img/piccone.svg" alt="">
            </div>
            <p>
            <h3>GeoSolution è uno studio specializzato nell’ingegneria e nella consulenza ambientale</h3>

            <br>
            <a href="https://it.vecteezy.com/vettori-gratis/terra">
                <div class="img-piccone"><img src="./assets/img/alberi.svg" alt=""></div>
            </a>

            <h3>L' obiettivo primario è quello di offrire un valido ausilio multidisciplinare per la <b> risoluzione
                    delle
                    problematiche</b> che interessano l’ambiente ed il territorio.</h3>

            <br>

            <a href="https://it.vecteezy.com/vettori-gratis/terra">
                <div class="img-piccone"><img src="./assets/img/earth.svg" alt=""></div>
            </a>

            <h3><b>Affidabilità</b>, <b> concretezza</b> e<b> know-how specializzato </b>fanno di
                GeoSolution un valido partner per studi di progettazione, ditte di costruzione e per ogni altra azienda
                operante sul territorio.</h3>
            </p>
            </p>
        </div>
        ...
        <div class="home-img-2 ">
            <div class="">
                <picture class="d-block w-100">
                    <source media="(min-width:1000px)" srcset="./assets/img/home-img-2-pc.jpg">
                    <source media="(min-width:650px)" srcset="./assets/img/home-img-2-tablet.jpg">
                    <source media="(min-width:465px)" srcset="./assets/img/home-img-2-mobile.jpg">
                    <img src="./assets/img/home-img-2-mobile.jpg" class="d-block w-100" alt="Flowers">
                </picture>
            </div>
        </div>
        ...
        <div class="container-dovesiamo">
            <h1>Dove Siamo</h1>

            <div class="container-maps">
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d5918.8058524658545!2d14.704517688360585!3d42.12025667398541!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x346b60805fcb287e!2sGeo%20Solution%20Studio%20di%20Geologia%20di%20Taddei%20Gianluca!5e0!3m2!1sit!2sit!4v1610893865955!5m2!1sit!2sit"
                    width="100%" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false"
                    tabindex="0"></iframe>
            </div>

            <div class="dovesiamo-descrizione">
                <img src="./assets/img/gps.svg" alt="gps" class="img-vettori-dovesiamo">
                <h5> Via Pitagora, 69, 66054 Vasto CH</h5>
                <img src="./assets/img/telefono.svg" alt="telefono" class="img-vettori-dovesiamo">
                <h5>Telefono: 0873 363279</h5>
                <img src="./assets/img/email.svg" alt="email" class="img-vettori-dovesiamo">
                <h5>Email: </h5>
                <br>


                <a href="./page-contatti/index.php"> <button type="button"
                        class="btn btn-lg btn-outline-light ">Contattami</button></a>
            </div>
        </div>
            ...
            <div id="myCarousel" class="carousel slide">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <!-- <img src="./assets/img/bg_home.jpg" class="d-block w-100" alt="..."> -->
                        <picture class="d-block w-100">
                            <source media="(min-width:1000px)" srcset="./assets/img/slider-foto/pc/slider-1.jpg">
                            <source media="(min-width:650px)" srcset="./assets/img/slider-foto/mobile/slider-1.jpg">
                            <source media="(min-width:465px)" srcset="./assets/img/slider-foto/mobile/slider-1.jpg">
                            <img src="./assets/img/slider-foto/mobile/slider-1.jpg" class="d-block w-100" alt="Flowers">
                        </picture>
                    </div>
                    <div class="carousel-item">
                        <!-- <img src="./assets/img/bg_home.jpg" class="d-block w-100" alt="..."> -->
                        <picture class="d-block w-100">
                            <source media="(min-width:1000px)" srcset="./assets/img/slider-foto/pc/slider-2.jpg">
                            <source media="(min-width:650px)" srcset="./assets/img/slider-foto/mobile/slider-2.jpg">
                            <source media="(min-width:465px)" srcset="./assets/img/slider-foto/mobile/slider-2.jpg">
                            <img src="./assets/img/slider-foto/mobile/slider-2.jpg" class="d-block w-100" alt="Flowers">
                        </picture>
                    </div>
                    <div class="carousel-item">
                        <!-- <img src="./assets/img/img-home.png" class="d-block w-100" alt="..."> -->
                        <picture class="d-block w-100">
                            <source media="(min-width:1000px)" srcset="./assets/img/slider-foto/pc/slider-3.jpg">
                            <source media="(min-width:650px)" srcset="./assets/img/slider-foto/mobile/slider-3.jpg">
                            <source media="(min-width:465px)" srcset="./assets/img/slider-foto/mobile/slider-3.jpg">
                            <img src="./assets/img/slider-foto/mobile/slider-3.jpg" class="d-block w-100" alt="Flowers">
                        </picture>
                    </div>
                </div>
